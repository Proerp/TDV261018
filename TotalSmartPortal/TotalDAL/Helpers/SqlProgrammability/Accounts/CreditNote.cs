...
namespace TotalDAL.Helpers.SqlProgrammability.Accounts
{
    public class CreditNote
    {
        ...
        public CreditNote(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void GetCreditNoteIndexes()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetCreditNoteIndexes", queryString);
        }
        ...
        private void CreditNoteSaveRelative()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("CreditNoteSaveRelative", queryString);
        }
        ...
        private void CreditNotePostSaveValidate()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("CreditNotePostSaveValidate", queryArray);
        }
        ...
        private void CreditNoteApproved()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("CreditNoteApproved", queryArray);
        }
        ...
        private void CreditNoteEditable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("CreditNoteEditable", queryArray);
        }
        ...
        private void CreditNoteToggleApproved()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("CreditNoteToggleApproved", queryString);
        }
        ...
        private void CreditNoteInitReference()
        {
            ...
            this.totalSmartPortalEntities.CreateTrigger("CreditNoteInitReference", simpleInitReference.CreateQuery());
        }
