...
namespace TotalDAL.Helpers.SqlProgrammability.Accounts
{
    public class Receipt
    {
        ...
        public Receipt(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void GetReceiptIndexes()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetReceiptIndexes", queryString);
        }
        ...
        private void GetGoodsIssueReceivables()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetGoodsIssueReceivables", queryString);
        }
        ...
        private void GetCustomerReceivables()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetCustomerReceivables", queryString);
        }
        ...
        private void GetPendingCustomerCredits()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetPendingCustomerCredits", queryString);
        }
        ...
        private void GetReceiptViewDetails()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetReceiptViewDetails", queryString);
        ...
        private void ReceiptSaveRelative()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("ReceiptSaveRelative", queryString);
        }
        ...
        private void ReceiptPostSaveValidate()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("ReceiptPostSaveValidate", queryArray);
        }
        ...
        private void ReceiptEditable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("ReceiptEditable", queryArray);
        }
        ...
        private void ReceiptInitReference()
        {
            ...
            this.totalSmartPortalEntities.CreateTrigger("ReceiptInitReference", simpleInitReference.CreateQuery());
        }
