...
namespace TotalDAL.Helpers.SqlProgrammability.Sales
{
    public class SalesOrder
    {
        ...
        public SalesOrder(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void GetSalesOrderIndexes()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetSalesOrderIndexes", queryString);
        }
        ...
        private void SalesOrderSaveRelative()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("SalesOrderSaveRelative", queryString);
            ...
            queryString = queryString + "           BEGIN " + "\r\n";
            queryString = queryString + "               INSERT INTO SalesOrders SELECT * FROM TotalSmartPortal.dbo.SalesOrders WHERE SalesOrderID = @EntityID " + "\r\n";
            queryString = queryString + "               INSERT INTO SalesOrderDetails SELECT * FROM TotalSmartPortal.dbo.SalesOrderDetails WHERE SalesOrderID = @EntityID " + "\r\n";
            queryString = queryString + "           END " + "\r\n";
        ...
        private void SalesOrderPostSaveValidate()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("SalesOrderPostSaveValidate", queryArray);
        }
        ...
        private void SalesOrderApproved()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("SalesOrderApproved", queryArray);
        }
        ...
        private void SalesOrderEditable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("SalesOrderEditable", queryArray);
        }
        ...
        private void SalesOrderVoidable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("SalesOrderVoidable", queryArray);
        }
        ...
        private void SalesOrderToggleApproved()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("SalesOrderToggleApproved", queryString);
        }
        ...
        private void SalesOrderToggleVoid()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("SalesOrderToggleVoid", queryString);
        }
        ...
        private void SalesOrderToggleVoidDetail()
        {
            ...
            queryString = queryString + "               THROW       61001,  @msg, 1; " + "\r\n";
            queryString = queryString + "           END " + "\r\n";
            this.totalSmartPortalEntities.CreateStoredProcedure("SalesOrderToggleVoidDetail", queryString);
        }
