...
namespace TotalDAL.Helpers.SqlProgrammability.Sales
{
    public class SalesReturn
    {
        ...
        public SalesReturn(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void GetSalesReturnIndexes()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetSalesReturnIndexes", queryString);
        }
        ...
        private void GetSalesReturnViewDetails()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetSalesReturnViewDetails", queryString);
        }
        ...
        private void GetSalesReturnPendingGoodsIssues()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetSalesReturnPendingGoodsIssues", queryString);
        }
        ...
        private void GetSalesReturnPendingGoodsIssueDetails()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetSalesReturnPendingGoodsIssueDetails", queryString);
        }
        ...
        private string BuildSQLNew(bool isGoodsIssueID, bool isGoodsIssueDetailIDs)
        {
            ...
            queryString = queryString + "                   0 AS Quantity, GoodsIssueDetails.ControlFreeQuantity, 0 AS FreeQuantity, GoodsIssueDetails.ListedPrice, GoodsIssueDetails.DiscountPercent, GoodsIssueDetails.UnitPrice, GoodsIssueDetails.TradeDiscountRate, GoodsIssueDetails.VATPercent, GoodsIssueDetails.ListedGrossPrice, GoodsIssueDetails.GrossPrice, 0 AS ListedAmount, 0 AS Amount, 0 AS ListedVATAmount, 0 AS VATAmount, 0 AS ListedGrossAmount, 0 AS GrossAmount, GoodsIssueDetails.IsBonus, GoodsIssues.Description, GoodsIssueDetails.Remarks, CAST(0 AS bit) AS IsSelected " + "\r\n";
        ...
        private void SalesReturnSaveRelative()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("SalesReturnSaveRelative", queryString);
            ...
            queryString = queryString + "           BEGIN " + "\r\n";
            queryString = queryString + "               INSERT INTO SalesReturns SELECT * FROM TotalSmartPortal.dbo.SalesReturns WHERE SalesReturnID = @EntityID " + "\r\n";
            queryString = queryString + "               INSERT INTO SalesReturnDetails SELECT * FROM TotalSmartPortal.dbo.SalesReturnDetails WHERE SalesReturnID = @EntityID " + "\r\n";
            queryString = queryString + "           END " + "\r\n";
            queryString = queryString + "       ELSE " + "\r\n";
            queryString = queryString + "           BEGIN " + "\r\n";
        ...
        private void SalesReturnPostSaveValidate()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("SalesReturnPostSaveValidate", queryArray);
        }
        ...
        private void SalesReturnApproved()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("SalesReturnApproved", queryArray);
        }
        ...
        private void SalesReturnEditable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("SalesReturnEditable", queryArray);
        }
        ...
        private void SalesReturnVoidable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("SalesReturnVoidable", queryArray);
        }
        ...
        private void SalesReturnToggleApproved()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("SalesReturnToggleApproved", queryString);
        }
        ...
        private void SalesReturnInitReference()
        {
            ...
            this.totalSmartPortalEntities.CreateTrigger("SalesReturnInitReference", simpleInitReference.CreateQuery());
        }
