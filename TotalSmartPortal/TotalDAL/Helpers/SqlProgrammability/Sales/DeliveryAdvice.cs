...
namespace TotalDAL.Helpers.SqlProgrammability.Sales
{
    public class DeliveryAdvice
    {
        ...
        public DeliveryAdvice(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void GetDeliveryAdviceIndexes()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetDeliveryAdviceIndexes", queryString);
        }
        ...
        private void GetCommoditiesInWarehouses(string storedProcedureName, bool withCommoditiesInGoodsReceipts, bool withCommoditiesInWarehouses, bool withCommodityTypeServices, bool getSavedData, bool includeCommoditiesOutOfStock, bool isUsingWarehouseBalancePrice)
        {
            ...
            string queryString = " @LocationID int, @CustomerID int, @WarehouseID int, @PriceCategoryID int, @ApplyToSalesVersusReturns int, @PromotionID int, @EntryDate DateTime, @SearchText nvarchar(60) " + (getSavedData ? ", @GoodsIssueID int, @StockTransferID int, @InventoryAdjustmentID int " : "") + "\r\n";
            //queryString = queryString + " WITH ENCRYPTION " + "\r\n";
            queryString = queryString + " AS " + "\r\n";
            ...
            queryString = queryString + "       IF (@@ROWCOUNT > 0) " + "\r\n";
            {
                ...
                if (!isUsingWarehouseBalancePrice) //GET 
                {
                    ...
                    queryString = queryString + "           SELECT @DiscountPercent = DiscountPercent, @ControlFreeQuantity = ControlFreeQuantity, @ApplyToAllCommodities = ApplyToAllCommodities FROM Promotions WHERE ((@ApplyToSalesVersusReturns >= 0 AND ApplyToSales = 1) OR (@ApplyToSalesVersusReturns <= 0 AND ApplyToReturns = 1)) AND PromotionID = @PromotionID AND InActive = 0 AND ApplyToTradeDiscount = 0 AND GetDate() >= StartDate AND GetDate() <= EndDate ";
                    ...
                    queryString = queryString + "                          (SELECT Promotions.PromotionID FROM Promotions WHERE ((@ApplyToSalesVersusReturns >= 0 AND Promotions.ApplyToSales = 1) OR (@ApplyToSalesVersusReturns <= 0 AND Promotions.ApplyToReturns = 1)) AND Promotions.InActive = 0 AND Promotions.ApplyToTradeDiscount = 0 AND GetDate() >= Promotions.StartDate AND GetDate() <= Promotions.EndDate AND Promotions.ApplyToAllCustomers = 1 " + "\r\n";
                    queryString = queryString + "                           UNION ALL " + "\r\n";
                    queryString = queryString + "                           SELECT Promotions.PromotionID FROM Promotions INNER JOIN PromotionCustomers ON ((@ApplyToSalesVersusReturns >= 0 AND Promotions.ApplyToSales = 1) OR (@ApplyToSalesVersusReturns <= 0 AND Promotions.ApplyToReturns = 1)) AND Promotions.InActive = 0 AND Promotions.ApplyToTradeDiscount = 0 AND GetDate() >= Promotions.StartDate AND GetDate() <= Promotions.EndDate AND PromotionCustomers.CustomerID = @CustomerID AND Promotions.PromotionID = PromotionCustomers.PromotionID " + "\r\n";
                    queryString = queryString + "                           UNION ALL " + "\r\n";
                    queryString = queryString + "                           SELECT Promotions.PromotionID FROM Promotions INNER JOIN PromotionCustomerCategories ON ((@ApplyToSalesVersusReturns >= 0 AND Promotions.ApplyToSales = 1) OR (@ApplyToSalesVersusReturns <= 0 AND Promotions.ApplyToReturns = 1)) AND Promotions.InActive = 0 AND Promotions.ApplyToTradeDiscount = 0 AND GetDate() >= Promotions.StartDate AND GetDate() <= Promotions.EndDate AND Promotions.PromotionID = PromotionCustomerCategories.PromotionID INNER JOIN AncestorCustomerCategories ON PromotionCustomerCategories.CustomerCategoryID = AncestorCustomerCategories.AncestorID AND AncestorCustomerCategories.CustomerCategoryID = @CustomerCategoryID " + "\r\n";
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure(storedProcedureName, queryString);
        }
        ...
        private void GetCustomerBases()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetCustomerBases", queryString);
        }
        ...
        private void GetShippingAddress()
        {
            ...
            queryString = queryString + "       SELECT      ISNULL(ShippingAddress, BillingAddress) AS ShippingAddress FROM Customers WHERE CustomerID = @CustomerID " + "\r\n";
            queryString = queryString + "       UNION ALL   " + "\r\n";
            queryString = queryString + "       SELECT      ShippingAddress FROM (" + "\r\n";
            ...
            queryString = queryString + "                   ORDER BY    MAX(EntryDate) DESC) TopShippingAddresses " + "\r\n";

            queryString = queryString + "    END " + "\r\n";

            this.totalSmartPortalEntities.CreateStoredProcedure("GetShippingAddress", queryString);
        }

        private void GetAddressees()
        {
            string queryString;
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetAddressees", queryString);
        }
        ...
        private void GetWarehouses()
        {
            ...
            queryString = queryString + "       SELECT      WarehouseID, Code, Name, WarehouseCategoryID, WarehouseGroupID, WarehouseClassID, LocationID, Bookable, Issuable, IsDefault, Remarks " + "\r\n";
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetWarehouses", queryString);
        }
        ...
        private void GetDeliveryAdviceViewDetails()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetDeliveryAdviceViewDetails", queryString);
        }
        ...
        private void GetDeliveryAdvicePendingSalesOrders()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetDeliveryAdvicePendingSalesOrders", queryString);
        }
        ...
        private void GetDeliveryAdvicePendingCustomers()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetDeliveryAdvicePendingCustomers", queryString);
        }
        ...
        private void GetDeliveryAdvicePendingSalesOrderDetails()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetDeliveryAdvicePendingSalesOrderDetails", queryString);
        }
        ...
        private void DeliveryAdviceSaveRelative()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("DeliveryAdviceSaveRelative", queryString);
            ...
            queryString = queryString + "           BEGIN " + "\r\n";
            queryString = queryString + "               INSERT INTO DeliveryAdvices SELECT * FROM TotalSmartPortal.dbo.DeliveryAdvices WHERE DeliveryAdviceID = @EntityID " + "\r\n";
            queryString = queryString + "               INSERT INTO DeliveryAdviceDetails SELECT * FROM TotalSmartPortal.dbo.DeliveryAdviceDetails WHERE DeliveryAdviceID = @EntityID " + "\r\n";
            queryString = queryString + "           END " + "\r\n";
            queryString = queryString + "       ELSE " + "\r\n";
            queryString = queryString + "           BEGIN " + "\r\n";
        ...
        private void DeliveryAdvicePostSaveValidate()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("DeliveryAdvicePostSaveValidate", queryArray);
        }
        ...
        private void DeliveryAdviceApproved()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("DeliveryAdviceApproved", queryArray);
        }
        ...
        private void DeliveryAdviceEditable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("DeliveryAdviceEditable", queryArray);
        }
        ...
        private void DeliveryAdviceVoidable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("DeliveryAdviceVoidable", queryArray);
        }
        ...
        private void DeliveryAdviceToggleApproved()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("DeliveryAdviceToggleApproved", queryString);
        }
        ...
        private void DeliveryAdviceToggleVoid()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("DeliveryAdviceToggleVoid", queryString);
        }
        ...
        private void DeliveryAdviceToggleVoidDetail()
        {
            ...
            queryString = queryString + "               THROW       61001,  @msg, 1; " + "\r\n";
            queryString = queryString + "           END " + "\r\n";
            this.totalSmartPortalEntities.CreateStoredProcedure("DeliveryAdviceToggleVoidDetail", queryString);
        }
        ...
        private void DeliveryAdviceInitReference()
        {
            ...
            this.totalSmartPortalEntities.CreateTrigger("DeliveryAdviceInitReference", simpleInitReference.CreateQuery());
        }
        ...
        private void DeliveryAdviceJournal()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("DeliveryAdviceJournal", queryString);
        }
