...
namespace TotalDAL.Helpers.SqlProgrammability.Reports
{
    public class SaleReports
    {
        ...
        private void GoodsIssueBalance()
        {
            ...
            queryString = queryString + " RETURNS @GoodsIssueBalances TABLE (NmvnTaskID int NOT NULL, TaskAction varchar(60) NOT NULL, EntryID int NOT NULL, EntryDate datetime NOT NULL, Reference nvarchar(10) NULL, WorkshiftID int NOT NULL, WorkshiftCode nvarchar(50) NOT NULL, WorkshiftCode nvarchar(100) NOT NULL, BillingAddress nvarchar(200) NOT NULL, WorkshiftCategoryID int NOT NULL, WorkshiftCategoryName nvarchar(100) NOT NULL, TradePromotionID int NULL, EntryAmount decimal(18, 2) NOT NULL, BalanceAmount decimal(18, 2) NOT NULL) " + "\r\n";
            //queryString = queryString + " WITH ENCRYPTION " + "\r\n";
            queryString = queryString + " AS " + "\r\n";
            queryString = queryString + "   BEGIN " + "\r\n";
        ...
        private string GoodsIssueBalanceSQLA(bool isWorkshiftID)
        {
            ...
            queryString = queryString + "       INSERT INTO @GoodsIssueBalances (NmvnTaskID, TaskAction, EntryID, EntryDate, Reference, WorkshiftID, WorkshiftCode, WorkshiftCode, BillingAddress, WorkshiftCategoryID, WorkshiftCategoryName, TradePromotionID, EntryAmount, BalanceAmount) " + "\r\n";

            queryString = queryString + "       SELECT      " + (int)GlobalEnums.NmvnTaskID.GoodsIssue + " AS NmvnTaskID, 'Inventories/GoodsIssues' AS TaskAction, GoodsIssues.GoodsIssueID, GoodsIssues.EntryDate, GoodsIssues.Reference, GoodsIssues.WorkshiftID, '' AS WorkshiftCode, '' AS WorkshiftCode, '' AS BillingAddress, 0 AS WorkshiftCategoryID, '' AS WorkshiftCategoryName, GoodsIssues.TradePromotionID, GoodsIssues.TotalGrossAmount, GoodsIssueBalances.BalanceAmount " + "\r\n";
            ...
            queryString = queryString + "       SELECT      NmvnTaskID, MAX(TaskAction), EntryID, MAX(EntryDate), MAX(Reference), MAX(WorkshiftID), '' AS WorkshiftCode, '' AS WorkshiftCode, '' AS BillingAddress, 0 AS WorkshiftCategoryID, '' AS WorkshiftCategoryName, NULL AS TradePromotionID, MAX(TotalCreditAmount), SUM(BalanceAmount)" + "\r\n";
        ...
        private string GoodsIssueBalanceSQLB(bool isWorkshiftCategoryID)
        {
            ...
            queryString = queryString + "       SET         Balances.WorkshiftCode = Workshifts.Code, Balances.WorkshiftCode = Workshifts.Name, Balances.BillingAddress = Workshifts.BillingAddress, Balances.WorkshiftCategoryID = Workshifts.WorkshiftCategoryID, Balances.WorkshiftCategoryName = WorkshiftCategories.Name " + "\r\n";
        ...
        private string SalesJournalSQL(bool isWorkshiftCategoryID, bool isWorkshiftID)
        {
            ...
            queryString = queryString + "       SELECT      NmvnTaskID, TaskAction, WorkshiftID, WorkshiftCode, WorkshiftCode, BillingAddress, WorkshiftCategoryID, WorkshiftCategoryName, " + "\r\n";
        ...
        private string StatementOfAccountSQL(bool isWorkshiftCategoryID, bool isWorkshiftID)
        {
            ...
            queryString = queryString + "       INSERT INTO     @StatementTable (NmvnTaskID, TaskAction, WorkshiftID, WorkshiftCode, WorkshiftCode, BillingAddress, WorkshiftCategoryID, WorkshiftCategoryName, EntryID, EntryDate, GoodsIssueID, GoodsIssueReference, TradePromotionID, CountGoodsIssueID, GoodsIssueListedGrossAmount, GoodsIssueGrossAmount, GoodsIssueDiscountAmount, AccountInvoiceID, AccountInvoiceReference, VATInvoiceNo, GoodsIssueReferences, SerialID, AccountInvoiceListedGrossAmount, AccountInvoiceGrossAmount, AccountInvoiceDiscountAmount, BeginningAmount, SumListedGrossAmount, TotalGrossAmount, TotalDiscountAmount, TotalReturnAmount, TotalReturnDiscountAmount, TotalCreditAmount, TotalCashReceiptAmount, TotalBankTransferAmount, TotalCashDiscount, TotalOtherDiscount, TotalFluctuationAmount, EndingAmount, EndingAmountInWords) " + "\r\n";
            queryString = queryString + "       SELECT          DISTINCT NULL AS NmvnTaskID, NULL AS TaskAction, WorkshiftID, WorkshiftCode, WorkshiftCode, BillingAddress, WorkshiftCategoryID, WorkshiftCategoryName, NULL AS EntryID, NULL AS EntryDate, NULL AS GoodsIssueID, NULL AS Reference, NULL AS TradePromotionID, 0 AS CountGoodsIssueID, 0 AS GoodsIssueListedGrossAmount, 0 AS GoodsIssueGrossAmount, 0 AS GoodsIssueDiscountAmount, NULL AS AccountInvoiceID, NULL AS AccountInvoiceReference, NULL AS VATInvoiceNo, NULL AS GoodsIssueReferences, NULL AS SerialID, 0 AS AccountInvoiceListedGrossAmount, 0 AS AccountInvoiceGrossAmount, 0 AS AccountInvoiceDiscountAmount, 0 AS BeginningAmount, 0 AS SumListedGrossAmount, 0 AS TotalGrossAmount, 0 AS TotalDiscountAmount, 0 AS TotalReturnAmount, 0 AS TotalReturnDiscountAmount, 0 AS TotalCreditAmount, 0 AS TotalCashReceiptAmount, 0 AS TotalBankTransferAmount, 0 AS TotalCashDiscount, 0 AS TotalOtherDiscount, 0 AS TotalFluctuationAmount, 0 AS EndingAmount, NULL AS EndingAmountInWords " + "\r\n";
            queryString = queryString + "       FROM            @SalesJournalTable " + "\r\n";
