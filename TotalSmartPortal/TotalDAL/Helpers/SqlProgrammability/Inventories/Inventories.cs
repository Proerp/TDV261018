...
namespace TotalDAL.Helpers.SqlProgrammability.Inventories
{
    public class Inventories
    {
        ...
        public Inventories(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void SPSKUBalanceUpdate()
        {
            ...
            //this.totalSmartPortalEntities.CreateStoredProcedure("SPSKUBalanceUpdate", queryString);
        ...
        private void GetFNSKUOverStock()
        {
            ...
            this.totalSmartPortalEntities.CreateUserDefinedFunction("GetOverStockItems", queryString);
        }
        ...
        private void UpdateWarehouseBalance()
        {
            ...
            queryString = queryString + "           WHERE       GoodsReceiptID = @GoodsReceiptID AND CommodityID IN (SELECT CommodityID FROM Commodities WHERE CommodityTypeID IN (" + (int)GlobalEnums.CommodityTypeID.Items + ", " + (int)GlobalEnums.CommodityTypeID.Consumables + "))" + "\r\n";
            queryString = queryString + "           GROUP BY    WarehouseID, CommodityID" + "\r\n";
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("UpdateWarehouseBalance", queryString);
        }
        ...
        public string GET_WarehouseJournal_BUILD_SQL(string commoditiesBalanceTable, string fromDate, string toDate, string warehouseIDList, string commodityIDList, string isFullJournal, string isAmountIncluded, string warehouseClassIDs, string warehouseGroupIDs)
        {
            ...
            if (GlobalEnums.ERPConnected)
            {
                ...
                queryString = queryString + "       INSERT INTO @SPSKUInventoryJournalTable EXEC ERmgrVCP.dbo.SPSKUInventoryJournal " + fromDate + ", " + toDate + ", " + (commodityIDList != null && commodityIDList != "" ? commodityIDList : "N''") + ", " + (warehouseGroupIDs != null && warehouseGroupIDs != "" ? (warehouseGroupIDs.IndexOf("@") >= 0 ? warehouseGroupIDs : "N'" + warehouseGroupIDs + "'") : "N''") + ", N'', N'', " + (warehouseClassIDs != null && warehouseClassIDs != "" && warehouseClassIDs.IndexOf("@") != -1 ? warehouseClassIDs : "N'" + warehouseClassIDs + "'") + ", " + (warehouseIDList != null && warehouseIDList != "" ? warehouseIDList : "N''") + "\r\n";
        ...
        private string SPSKUInventoryJournalSQLA(bool isWarehouseGroupFilter, bool isWarehouseFilter, bool isCommodityFilter)
        {
            ...
            queryString = queryString + "                   SKUJournalMaster.QuantityOnTransfer, SKUJournalMaster.QuantityOnReturn, SKUJournalMaster.QuantityOnAdvice, SKUJournalMaster.QuantityOnTransferAdviceOut, SKUJournalMaster.QuantityOnTransferAdviceIn, SKUJournalMaster.QuantityOnProduction, 0 AS UPriceNMDInventory, " + "\r\n";
            ...
            queryString = queryString + "                                   SUM(QuantityOnTransfer) AS QuantityOnTransfer, SUM(QuantityOnReturn) AS QuantityOnReturn, SUM(QuantityOnAdvice) AS QuantityOnAdvice, SUM(QuantityOnTransferAdviceOut) AS QuantityOnTransferAdviceOut, SUM(QuantityOnTransferAdviceIn) AS QuantityOnTransferAdviceIn, SUM(QuantityOnProduction) AS QuantityOnProduction " + "\r\n";
        ...
        private string SPSKUInventoryJournalSQLB(bool isWarehouseGroupFilter, bool isWarehouseFilter, bool isCommodityFilter)
        {
            ...
            queryString = queryString + "                                       0 AS QuantityOnTransfer, 0 AS QuantityOnReturn, 0 AS QuantityOnAdvice, 0 AS QuantityOnTransferAdviceOut, 0 AS QuantityOnTransferAdviceIn, 0 AS QuantityOnProduction " + "\r\n";
            ...
            queryString = queryString + "                                       CASE WHEN SKUInputMaster.SKUInputDate >= @LocalDateFrom AND SKUInputMaster.SKUInputVoucherTypeID = " + (int)ENMVNTaskID.EsReturn + " THEN SKUInputDetail.Quantity ELSE 0 END AS QuantityInputRTN, CASE WHEN SKUInputMaster.SKUInputDate >= @LocalDateFrom AND SKUInputMaster.SKUInputVoucherTypeID = " + (int)ENMVNTaskID.ESKUTransfer + " THEN SKUInputDetail.Quantity ELSE 0 END AS QuantityInputTRF, " + "\r\n";
            ...
            queryString = queryString + "                                       ListWarehouseName ON GoodsIssueDetails.WarehouseID = ListWarehouseName.WarehouseID INNER JOIN " + "\r\n";
            ...
            queryString = queryString + "                                       0 AS QuantityOutputINV, 0 AS QuantityOutputGoodsIssue, 0 AS QuantityOutputTRF, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOutputADJ, 0 AS QuantityOutputBLD, 0 AS QuantityOutputUBL, " + "\r\n";
            queryString = queryString + "                                       ROUND(SKUTransferDetail.Quantity - SKUTransferDetail.QuantityInput, " + (int)GlobalEnums.rndQuantity + ") AS QuantityOnTransfer, 0 AS QuantityOnReturn, 0 AS QuantityOnAdvice, 0 AS QuantityOnTransferAdviceOut, 0 AS QuantityOnTransferAdviceIn, 0 AS QuantityOnProduction " + "\r\n";
            queryString = queryString + "                           FROM        SKUTransferMaster INNER JOIN " + "\r\n";
            queryString = queryString + "                                       SKUTransferDetail ON SKUTransferMaster.SKUTransferID = SKUTransferDetail.SKUTransferID INNER JOIN " + "\r\n";
            ...
            queryString = queryString + "                                       0 AS QuantityOutputINV, 0 AS QuantityOutputGoodsIssue, 0 AS QuantityOutputTRF, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOutputADJ, 0 AS QuantityOutputBLD, 0 AS QuantityOutputUBL, " + "\r\n";
            queryString = queryString + "                                       SKUInputDetail.Quantity AS QuantityOnTransfer, 0 AS QuantityOnReturn, 0 AS QuantityOnAdvice, 0 AS QuantityOnTransferAdviceOut, 0 AS QuantityOnTransferAdviceIn, 0 AS QuantityOnProduction " + "\r\n";
            ...
            queryString = queryString + "                                       0 AS QuantityOutputINV, 0 AS QuantityOutputGoodsIssue, 0 AS QuantityOutputTRF, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOutputADJ, 0 AS QuantityOutputBLD, 0 AS QuantityOutputUBL, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOnTransfer, 0 AS QuantityOnReturn, ROUND(DeliveryAdviceDetails.Quantity + DeliveryAdviceDetails.FreeQuantity - DeliveryAdviceDetails.QuantityIssue - DeliveryAdviceDetails.FreeQuantityIssue, " + (int)GlobalEnums.rndQuantity + ") AS QuantityOnAdvice, 0 AS QuantityOnTransferAdviceOut, 0 AS QuantityOnTransferAdviceIn, 0 AS QuantityOnProduction " + "\r\n";
            ...
            queryString = queryString + "                                       0 AS QuantityOutputINV, 0 AS QuantityOutputGoodsIssue, 0 AS QuantityOutputTRF, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOutputADJ, 0 AS QuantityOutputBLD, 0 AS QuantityOutputUBL, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOnTransfer, 0 AS QuantityOnReturn, GoodsIssueDetails.Quantity + GoodsIssueDetails.FreeQuantity AS QuantityOnAdvice, 0 AS QuantityOnTransferAdviceOut, 0 AS QuantityOnTransferAdviceIn, 0 AS QuantityOnProduction " + "\r\n";
            ...
            queryString = queryString + "                                       0 AS QuantityOutputINV, 0 AS QuantityOutputGoodsIssue, 0 AS QuantityOutputTRF, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOutputADJ, 0 AS QuantityOutputBLD, 0 AS QuantityOutputUBL, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOnTransfer, 0 AS QuantityOnReturn, 0 AS QuantityOnAdvice, ROUND(SKUTransferAdviceDetail.Quantity - SKUTransferAdviceDetail.QuantityInput, " + (int)GlobalEnums.rndQuantity + ") AS QuantityOnTransferAdviceOut, 0 AS QuantityOnTransferAdviceIn, 0 AS QuantityOnProduction " + "\r\n";
            ...
            queryString = queryString + "                                       0 AS QuantityOutputINV, 0 AS QuantityOutputGoodsIssue, 0 AS QuantityOutputTRF, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOutputADJ, 0 AS QuantityOutputBLD, 0 AS QuantityOutputUBL, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOnTransfer, 0 AS QuantityOnReturn, 0 AS QuantityOnAdvice, SKUTransferDetail.Quantity AS QuantityOnTransferAdviceOut, 0 AS QuantityOnTransferAdviceOut, 0 AS QuantityOnProduction " + "\r\n";
            queryString = queryString + "                           FROM        SKUTransferAdviceMaster INNER JOIN " + "\r\n";
            ...
            queryString = queryString + "                                       0 AS QuantityOutputINV, 0 AS QuantityOutputGoodsIssue, 0 AS QuantityOutputTRF, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOutputADJ, 0 AS QuantityOutputBLD, 0 AS QuantityOutputUBL, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOnTransfer, 0 AS QuantityOnReturn, 0 AS QuantityOnAdvice, 0 AS QuantityOnTransferAdviceOut, ROUND(SKUTransferAdviceDetail.Quantity - SKUTransferAdviceDetail.QuantityInput, " + (int)GlobalEnums.rndQuantity + ") AS QuantityOnTransferAdviceIn, 0 AS QuantityOnProduction " + "\r\n";
            queryString = queryString + "                           FROM        SKUTransferAdviceMaster INNER JOIN " + "\r\n";
            queryString = queryString + "                                       SKUTransferAdviceDetail ON SKUTransferAdviceMaster.SKUTransferAdviceID = SKUTransferAdviceDetail.SKUTransferAdviceID INNER JOIN " + "\r\n";
            ...
            queryString = queryString + "                                       0 AS QuantityOutputINV, 0 AS QuantityOutputGoodsIssue, 0 AS QuantityOutputTRF, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOutputADJ, 0 AS QuantityOutputBLD, 0 AS QuantityOutputUBL, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOnTransfer, 0 AS QuantityOnReturn, 0 AS QuantityOnAdvice, 0 AS QuantityOnTransferAdviceOut, SKUTransferDetail.Quantity AS QuantityOnTransferAdviceIn, 0 AS QuantityOnProduction " + "\r\n";
            queryString = queryString + "                           FROM        SKUTransferAdviceMaster INNER JOIN " + "\r\n";
            queryString = queryString + "                                       SKUTransferDetail ON SKUTransferAdviceMaster.SKUTransferAdviceID = SKUTransferDetail.SKUTransferAdviceID INNER JOIN " + "\r\n";
            queryString = queryString + "                                       SKUTransferMaster ON SKUTransferDetail.SKUTransferID = SKUTransferMaster.SKUTransferID INNER JOIN " + "\r\n";
            queryString = queryString + "                                       ListWarehouseName ON SKUTransferDetail.WarehouseInID = ListWarehouseName.WarehouseID " + "\r\n";
            ...
            queryString = queryString + "                                       0 AS QuantityOutputINV, 0 AS QuantityOutputGoodsIssue, 0 AS QuantityOutputTRF, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOutputADJ, 0 AS QuantityOutputBLD, 0 AS QuantityOutputUBL, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOnTransfer, 0 AS QuantityOnReturn, 0 AS QuantityOnAdvice, 0 AS QuantityOnTransferAdviceOut, 0 AS QuantityOnTransferAdviceIn, ROUND(ProductionOrderDetail.Quantity - ProductionOrderDetail.QuantityInput, " + (int)GlobalEnums.rndQuantity + ") AS QuantityOnProduction " + "\r\n";
            ...
            queryString = queryString + "                                       0 AS QuantityOutputINV, 0 AS QuantityOutputGoodsIssue, 0 AS QuantityOutputTRF, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOutputADJ, 0 AS QuantityOutputBLD, 0 AS QuantityOutputUBL, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOnTransfer, 0 AS QuantityOnReturn, 0 AS QuantityOnAdvice, 0 AS QuantityOnTransferAdviceOut, 0 AS QuantityOnTransferAdviceIn, ProductionSemiDetail.Quantity AS QuantityOnProduction " + "\r\n";
            ...
            queryString = queryString + "                                       0 AS QuantityOutputINV, 0 AS QuantityOutputGoodsIssue, 0 AS QuantityOutputTRF, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOutputADJ, 0 AS QuantityOutputBLD, 0 AS QuantityOutputUBL, " + "\r\n";
            queryString = queryString + "                                       0 AS QuantityOnTransfer, 0 AS QuantityOnReturn, 0 AS QuantityOnAdvice, 0 AS QuantityOnTransferAdviceOut, 0 AS QuantityOnTransferAdviceIn, CASE WHEN ProductionRankDetail.WarehouseClassID IN (" + (int)EWarehouseClassID.EWarehouseClassL2 + ", " + (int)EWarehouseClassID.EWarehouseClassL3 + ") THEN -ProductionRankDetail.Quantity ELSE ProductionRankDetail.Quantity END AS QuantityOnProduction " + "\r\n";
        ...
        {
            return isCommodityFilter ? " AND " + (tableName != "" ? tableName + "." : "") + "CommodityID IN (SELECT CommodityID FROM @CommodityFilter) " : (tableName == "GoodsIssueDetails" ? " AND " + (tableName != "" ? tableName + "." : "") + "CommodityTypeID IN (" + (int)GlobalEnums.CommodityTypeID.Items + ", " + (int)GlobalEnums.CommodityTypeID.Consumables + ") " : "");
        }
        ...
        public void WarehouseJournalTESTSummary()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("WarehouseJournalTESTSummary", queryString);
        }
        ...
        private void WarehouseJournal()
        {
            ...
            queryString = queryString + "       DECLARE     @CommodityFilter TABLE (CommodityID int NOT NULL) " + "\r\n";
            queryString = queryString + "       IF (@LocalCommodityIDList <> '') " + "\r\n";
            queryString = queryString + "                   INSERT INTO @CommodityFilter SELECT Id FROM dbo.SplitToIntList (@LocalCommodityIDList) " + "       WHERE Id IN (SELECT CommodityID FROM Commodities WHERE CommodityTypeID IN (" + (int)GlobalEnums.CommodityTypeID.Items + ", " + (int)GlobalEnums.CommodityTypeID.Consumables + ")) " + "\r\n";
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("WarehouseJournal", queryString);
        }
        ...
        {
            return isCommodityFilter ? " AND " + (tableName != "" ? tableName + "." : "") + "CommodityID IN (SELECT CommodityID FROM @CommodityFilter) " : (tableName == "WarehouseBalanceDetail" ? "" : " AND " + (tableName != "" ? tableName + "." : "") + "CommodityTypeID IN (" + (int)GlobalEnums.CommodityTypeID.Items + ", " + (int)GlobalEnums.CommodityTypeID.Consumables + ") ");
        }
        ...
        private string VehicleJournalBUILD(bool isAllWarehouses)
        {
            ...
            queryString = queryString + "                                   FROM        GoodsReceiptDetails " + "\r\n";
            queryString = queryString + "                                   WHERE       GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + (isAllWarehouses ? "" : " AND GoodsReceiptDetails.WarehouseID = @LocalWarehouseID ") + " AND GoodsReceiptDetails.EntryDate < @LocalFromDate AND GoodsReceiptDetails.Quantity > GoodsReceiptDetails.QuantityIssue " + "\r\n";
            ...
            queryString = queryString + "                                   FROM        GoodsReceiptDetails INNER JOIN " + "\r\n";
            queryString = queryString + "                                               SalesInvoiceDetails ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + (isAllWarehouses ? "" : " AND GoodsReceiptDetails.WarehouseID = @LocalWarehouseID ") + " AND GoodsReceiptDetails.GoodsReceiptDetailID = SalesInvoiceDetails.GoodsReceiptDetailID AND GoodsReceiptDetails.EntryDate < @LocalFromDate AND SalesInvoiceDetails.EntryDate >= @LocalFromDate " + "\r\n";
            ...
            queryString = queryString + "                                   FROM        GoodsReceiptDetails INNER JOIN " + "\r\n";
            queryString = queryString + "                                               StockTransferDetails ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + (isAllWarehouses ? "" : " AND GoodsReceiptDetails.WarehouseID = @LocalWarehouseID ") + " AND GoodsReceiptDetails.GoodsReceiptDetailID = StockTransferDetails.GoodsReceiptDetailID AND GoodsReceiptDetails.EntryDate < @LocalFromDate AND StockTransferDetails.EntryDate >= @LocalFromDate " + "\r\n";
            ...
            queryString = queryString + "                                   FROM        GoodsReceiptDetails " + "\r\n";
            queryString = queryString + "                                   WHERE       GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + (isAllWarehouses ? "" : " AND GoodsReceiptDetails.WarehouseID = @LocalWarehouseID ") + " AND GoodsReceiptDetails.EntryDate >= @LocalFromDate AND GoodsReceiptDetails.EntryDate <= @LocalToDate " + "\r\n";
            ...
            queryString = queryString + "                                   FROM        SalesInvoiceDetails " + "\r\n";
            queryString = queryString + "                                   WHERE       SalesInvoiceDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + (isAllWarehouses ? "" : " AND SalesInvoiceDetails.WarehouseID = @LocalWarehouseID ") + " AND SalesInvoiceDetails.EntryDate >= @LocalFromDate AND SalesInvoiceDetails.EntryDate <= @LocalToDate " + "\r\n";
            ...
            queryString = queryString + "                                   FROM        StockTransferDetails " + "\r\n";
            queryString = queryString + "                                   WHERE       StockTransferDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + (isAllWarehouses ? "" : " AND StockTransferDetails.WarehouseID = @LocalWarehouseID ") + " AND StockTransferDetails.EntryDate >= @LocalFromDate AND StockTransferDetails.EntryDate <= @LocalToDate " + "\r\n";
            ...
            queryString = queryString + "                   WHERE   PurchaseOrderDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + (isAllWarehouses ? "" : " AND PurchaseOrderDetails.LocationID = @LocationID ") + " AND PurchaseOrderDetails.EntryDate <= @LocalToDate AND PurchaseOrderDetails.Quantity > PurchaseOrderDetails.QuantityInvoice " + "\r\n";
            ...
            queryString = queryString + "                           PurchaseInvoiceDetails ON PurchaseInvoiceDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + (isAllWarehouses ? "" : " AND PurchaseOrders.LocationID = @LocationID ") + " AND PurchaseOrders.PurchaseOrderID = PurchaseInvoiceDetails.PurchaseOrderID " + "\r\n";
            ...
            queryString = queryString + "                   WHERE   PurchaseInvoiceDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + (isAllWarehouses ? "" : " AND PurchaseInvoiceDetails.LocationID = @LocationID ") + " AND PurchaseInvoiceDetails.EntryDate <= @LocalToDate AND PurchaseInvoiceDetails.Quantity > PurchaseInvoiceDetails.QuantityReceipt " + "\r\n";
            ...
            queryString = queryString + "                           GoodsReceiptDetails ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + (isAllWarehouses ? "" : " AND PurchaseInvoices.LocationID = @LocationID ") + " AND PurchaseInvoices.PurchaseInvoiceID = GoodsReceiptDetails.VoucherID AND GoodsReceiptDetails.GoodsReceiptTypeID = " + (int)GlobalEnums.GoodsReceiptTypeID.PurchaseInvoice + " AND PurchaseInvoices.EntryDate <= @LocalToDate AND GoodsReceiptDetails.EntryDate > @LocalToDate " + "\r\n";
            ...
            queryString = queryString + "                           0 AS QuantityBegin, 0 AS QuantityInputINV, 0 AS QuantityInputRTN, 0 AS QuantityInputTRF, 0 AS QuantityInputADJ, 0 AS QuantityIssueINV, 0 AS QuantityIssueTRF, 0 AS QuantityIssueADJ, 0 AS QuantityOnPurchasing, GoodsReceiptDetails.Quantity AS QuantityOnReceipt, 0 AS UnitPrice, 0 AS MovementMIN, 0 AS MovementMAX, 0 AS MovementAVG " + "\r\n";
            queryString = queryString + "                   FROM    StockTransfers INNER JOIN " + "\r\n";
            queryString = queryString + "                           GoodsReceiptDetails ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + (isAllWarehouses ? "" : " AND StockTransfers.WarehouseID = @LocalWarehouseID ") + " AND StockTransfers.StockTransferID = GoodsReceiptDetails.VoucherID AND GoodsReceiptDetails.GoodsReceiptTypeID = " + (int)GlobalEnums.GoodsReceiptTypeID.StockTransfer + " AND StockTransfers.EntryDate <= @LocalToDate AND GoodsReceiptDetails.EntryDate > @LocalToDate " + "\r\n";
            //--ON INPUT.END
        ...
        private void VehicleCard()
        {
            ...
            queryString = queryString + "                   FROM        GoodsReceiptDetails INNER JOIN " + "\r\n";
            queryString = queryString + "                               PurchaseInvoices ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND GoodsReceiptDetails.WarehouseID = @LocalWarehouseID AND GoodsReceiptDetails.VoucherID = PurchaseInvoices.PurchaseInvoiceID AND GoodsReceiptDetails.GoodsReceiptTypeID = " + (int)GlobalEnums.GoodsReceiptTypeID.PurchaseInvoice + " AND GoodsReceiptDetails.Quantity > GoodsReceiptDetails.QuantityIssue AND GoodsReceiptDetails.EntryDate < @LocalFromDate INNER JOIN " + "\r\n";
            queryString = queryString + "                               Customers Suppliers ON PurchaseInvoices.SupplierID = Suppliers.CustomerID " + "\r\n";
            ...
            queryString = queryString + "                   FROM        GoodsReceiptDetails INNER JOIN " + "\r\n";
            queryString = queryString + "                               StockTransfers ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND GoodsReceiptDetails.WarehouseID = @LocalWarehouseID AND GoodsReceiptDetails.VoucherID = StockTransfers.StockTransferID AND GoodsReceiptDetails.GoodsReceiptTypeID = " + (int)GlobalEnums.GoodsReceiptTypeID.StockTransfer + " AND GoodsReceiptDetails.Quantity > GoodsReceiptDetails.QuantityIssue AND GoodsReceiptDetails.EntryDate < @LocalFromDate INNER JOIN " + "\r\n";
            queryString = queryString + "                               Locations ON StockTransfers.LocationID = Locations.LocationID " + "\r\n";
            ...
            queryString = queryString + "                   FROM        GoodsReceiptDetails INNER JOIN " + "\r\n";
            queryString = queryString + "                               SalesInvoiceDetails ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND GoodsReceiptDetails.WarehouseID = @LocalWarehouseID AND GoodsReceiptDetails.GoodsReceiptDetailID = SalesInvoiceDetails.GoodsReceiptDetailID AND GoodsReceiptDetails.EntryDate < @LocalFromDate AND SalesInvoiceDetails.EntryDate >= @LocalFromDate INNER JOIN " + "\r\n";
            ...
            queryString = queryString + "                   FROM        GoodsReceiptDetails INNER JOIN " + "\r\n";
            queryString = queryString + "                               StockTransferDetails ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND GoodsReceiptDetails.WarehouseID = @LocalWarehouseID AND GoodsReceiptDetails.GoodsReceiptDetailID = StockTransferDetails.GoodsReceiptDetailID AND GoodsReceiptDetails.EntryDate < @LocalFromDate AND StockTransferDetails.EntryDate >= @LocalFromDate INNER JOIN " + "\r\n";
            queryString = queryString + "                               PurchaseInvoices ON GoodsReceiptDetails.VoucherID = PurchaseInvoices.PurchaseInvoiceID AND GoodsReceiptDetails.GoodsReceiptTypeID = " + (int)GlobalEnums.GoodsReceiptTypeID.PurchaseInvoice + " INNER JOIN " + "\r\n";
            queryString = queryString + "                               Customers Suppliers ON PurchaseInvoices.SupplierID = Suppliers.CustomerID " + "\r\n";
            ...
            queryString = queryString + "                   FROM        GoodsReceiptDetails INNER JOIN " + "\r\n";
            queryString = queryString + "                               PurchaseInvoices ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND GoodsReceiptDetails.WarehouseID = @LocalWarehouseID AND GoodsReceiptDetails.VoucherID = PurchaseInvoices.PurchaseInvoiceID AND GoodsReceiptDetails.GoodsReceiptTypeID = " + (int)GlobalEnums.GoodsReceiptTypeID.PurchaseInvoice + " AND GoodsReceiptDetails.EntryDate >= @LocalFromDate AND GoodsReceiptDetails.EntryDate <= @LocalToDate INNER JOIN " + "\r\n";
            queryString = queryString + "                               Customers Suppliers ON PurchaseInvoices.SupplierID = Suppliers.CustomerID " + "\r\n";
            ...
            queryString = queryString + "                   FROM        GoodsReceiptDetails INNER JOIN " + "\r\n";
            queryString = queryString + "                               StockTransfers ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND GoodsReceiptDetails.WarehouseID = @LocalWarehouseID AND GoodsReceiptDetails.VoucherID = StockTransfers.StockTransferID AND GoodsReceiptDetails.GoodsReceiptTypeID = " + (int)GlobalEnums.GoodsReceiptTypeID.StockTransfer + " AND GoodsReceiptDetails.EntryDate >= @LocalFromDate AND GoodsReceiptDetails.EntryDate <= @LocalToDate INNER JOIN " + "\r\n";
            queryString = queryString + "                               Locations ON StockTransfers.LocationID = Locations.LocationID " + "\r\n";
            ...
            queryString = queryString + "                   FROM        SalesInvoiceDetails INNER JOIN " + "\r\n";
            queryString = queryString + "                               GoodsReceiptDetails ON SalesInvoiceDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND SalesInvoiceDetails.WarehouseID = @LocalWarehouseID AND SalesInvoiceDetails.GoodsReceiptDetailID = GoodsReceiptDetails.GoodsReceiptDetailID AND SalesInvoiceDetails.EntryDate >= @LocalFromDate AND SalesInvoiceDetails.EntryDate <= @LocalToDate INNER JOIN " + "\r\n";
            queryString = queryString + "                               Customers ON SalesInvoiceDetails.CustomerID = Customers.CustomerID " + "\r\n";
            ...
            queryString = queryString + "                   FROM        StockTransferDetails INNER JOIN " + "\r\n";
            queryString = queryString + "                               GoodsReceiptDetails ON StockTransferDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND StockTransferDetails.WarehouseID = @LocalWarehouseID AND StockTransferDetails.GoodsReceiptDetailID = GoodsReceiptDetails.GoodsReceiptDetailID AND StockTransferDetails.EntryDate >= @LocalFromDate AND StockTransferDetails.EntryDate <= @LocalToDate INNER JOIN " + "\r\n";
            ...
            queryString = queryString + "                   FROM        PurchaseOrders INNER JOIN " + "\r\n";
            queryString = queryString + "                               PurchaseInvoiceDetails ON PurchaseInvoiceDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND PurchaseOrders.LocationID = @LocationID AND PurchaseOrders.PurchaseOrderID = PurchaseInvoiceDetails.PurchaseOrderID AND PurchaseOrders.EntryDate <= @LocalToDate AND PurchaseInvoiceDetails.EntryDate > @LocalToDate INNER JOIN " + "\r\n";
            ...
            queryString = queryString + "                               PurchaseInvoices ON PurchaseInvoiceDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND PurchaseInvoiceDetails.LocationID = @LocationID AND PurchaseInvoiceDetails.EntryDate <= @LocalToDate AND PurchaseInvoiceDetails.Quantity > PurchaseInvoiceDetails.QuantityReceipt AND PurchaseInvoiceDetails.PurchaseInvoiceID = PurchaseInvoices.PurchaseInvoiceID INNER JOIN " + "\r\n";
            ...
            queryString = queryString + "                   FROM        PurchaseInvoices INNER JOIN " + "\r\n";
            queryString = queryString + "                               GoodsReceiptDetails ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND PurchaseInvoices.LocationID = @LocationID AND PurchaseInvoices.PurchaseInvoiceID = GoodsReceiptDetails.VoucherID AND GoodsReceiptDetails.GoodsReceiptTypeID = " + (int)GlobalEnums.GoodsReceiptTypeID.PurchaseInvoice + " AND PurchaseInvoices.EntryDate <= @LocalToDate AND GoodsReceiptDetails.EntryDate > @LocalToDate INNER JOIN " + "\r\n";
            queryString = queryString + "                               Customers Suppliers ON PurchaseInvoices.SupplierID = Suppliers.CustomerID " + "\r\n";
            ...
            queryString = queryString + "                   FROM        StockTransfers INNER JOIN " + "\r\n";
            queryString = queryString + "                               StockTransferDetails ON StockTransfers.StockTransferID = StockTransferDetails.StockTransferID AND StockTransferDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND StockTransfers.WarehouseID = @LocalWarehouseID AND StockTransferDetails.EntryDate <= @LocalToDate AND StockTransferDetails.Quantity > StockTransferDetails.QuantityReceipt INNER JOIN " + "\r\n";
            queryString = queryString + "                               Locations ON StockTransfers.LocationID = Locations.LocationID " + "\r\n";
            ...
            queryString = queryString + "                   FROM        StockTransfers INNER JOIN " + "\r\n";
            queryString = queryString + "                               GoodsReceiptDetails ON GoodsReceiptDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + " AND StockTransfers.WarehouseID = @LocalWarehouseID AND StockTransfers.StockTransferID = GoodsReceiptDetails.VoucherID AND GoodsReceiptDetails.GoodsReceiptTypeID = " + (int)GlobalEnums.GoodsReceiptTypeID.StockTransfer + " AND StockTransfers.EntryDate <= @LocalToDate AND GoodsReceiptDetails.EntryDate > @LocalToDate INNER JOIN " + "\r\n";
            queryString = queryString + "                               Locations ON StockTransfers.LocationID = Locations.LocationID " + "\r\n";
            //--ON INPUT.END
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("VehicleCard", queryString);
        ...
        private void VWCommodityCategories()
        {
            ...
            this.totalSmartPortalEntities.CreateView("VWCommodityCategories", queryString);
        ...
        private void SalesInvoiceJournal()
        {
            ...
            queryString = queryString + "       IF          (@CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Products + ") " + "\r\n";
            queryString = queryString + "                   " + this.SalesInvoiceJournalBuild(GlobalEnums.CommodityTypeID.Products) + "\r\n";
            queryString = queryString + "       ELSE    IF  (@CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Items + ")  " + "\r\n";
            queryString = queryString + "                   " + this.SalesInvoiceJournalBuild(GlobalEnums.CommodityTypeID.Items) + "\r\n";
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("SalesInvoiceJournal", queryString);
        }
        ...
        private string SalesInvoiceJournalBuildDetail(GlobalEnums.CommodityTypeID commodityTypeID, bool locationFilter)
        {
            ...
            if (commodityTypeID == GlobalEnums.CommodityTypeID.Products)
                ...
                if (commodityTypeID == GlobalEnums.CommodityTypeID.Items || commodityTypeID == GlobalEnums.CommodityTypeID.Consumables)
