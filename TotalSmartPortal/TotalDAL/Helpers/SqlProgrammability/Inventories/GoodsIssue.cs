...
namespace TotalDAL.Helpers.SqlProgrammability.Inventories
{
    ...
    public class GoodsIssue
    {
        ...
        private void GoodsIssueSheet()
        {
            ...
            queryString = queryString + "       SELECT          GoodsIssues.GoodsIssueID, GoodsIssues.EntryDate, GoodsIssues.Reference, GoodsIssues.Code AS GoodsIssueCode, GoodsIssues.PaymentTermID, PaymentTerms.Name AS PaymentTermName, GoodsIssues.Description, GoodsIssues.Remarks, " + "\r\n";
