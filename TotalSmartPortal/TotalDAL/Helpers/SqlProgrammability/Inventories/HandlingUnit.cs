...
namespace TotalDAL.Helpers.SqlProgrammability.Inventories
{
    public class HandlingUnit
    {
        ...
        public HandlingUnit(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void GetHandlingUnitIndexes()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetHandlingUnitIndexes", queryString);
        }
        ...
        private void GetHandlingUnitViewDetails()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetHandlingUnitViewDetails", queryString);
        }
        ...
        private void GetHandlingUnitPendingGoodsIssues()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetHandlingUnitPendingGoodsIssues", queryString);
        }
        ...
        private void GetHandlingUnitPendingCustomers()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetHandlingUnitPendingCustomers", queryString);
        }
        ...
        private void GetHandlingUnitPendingGoodsIssueDetails()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetHandlingUnitPendingGoodsIssueDetails", queryString);
        }
        ...
        private void HandlingUnitSaveRelative()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("HandlingUnitSaveRelative", queryString);
        }
        ...
        private void HandlingUnitPostSaveValidate()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("HandlingUnitPostSaveValidate", queryArray);
        }
        ...
        private void HandlingUnitEditable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("HandlingUnitEditable", queryArray);
        }
        ...
        private void HandlingUnitInitReference()
        {
            ...
            this.totalSmartPortalEntities.CreateTrigger("HandlingUnitInitReference", simpleInitReference.CreateQuery());
        }
        ...
        private void HandlingUnitSheet()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("HandlingUnitSheet", queryString);
        }
