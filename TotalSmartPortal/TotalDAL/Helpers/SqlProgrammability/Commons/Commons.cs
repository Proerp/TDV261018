...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class Commons
    {
        ...
        public Commons(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void SplitToIntList()
        {
            ...
            this.totalSmartPortalEntities.CreateUserDefinedFunction("SplitToIntList", queryString);
        }
        ...
        private void EntireTerritories()
        {
            ...
            this.totalSmartPortalEntities.CreateView("VWTerritories", queryString);
        }
        ...
        private void EntireCommodityBrands()
        {
            ...
            this.totalSmartPortalEntities.CreateView("VWCommodityBrands", queryString);
        }
        ...
        private void EntireCustomerCategories()
        {
            ...
            this.totalSmartPortalEntities.CreateView("VWCustomerCategories", queryString);
        }
