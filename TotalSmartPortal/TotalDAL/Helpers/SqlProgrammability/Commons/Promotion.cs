...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class Promotion
    {
        ...
        public Promotion(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void GetPromotionIndexes()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetPromotionIndexes", queryString);
        }
        ...
        private void GetPromotionByCustomers()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetPromotionByCustomers", queryString);
        }
        ...
        private void GetPromotionCustomerCategories()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetPromotionCustomerCategories", queryString);
        }
        ...
        private void AddPromotionCustomerCategories()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("AddPromotionCustomerCategories", queryString);
        }
        ...
        private void RemovePromotionCustomerCategories()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("RemovePromotionCustomerCategories", queryString);
        ...
        private void AddPromotionCustomers()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("AddPromotionCustomers", queryString);
        }
        ...
        private void RemovePromotionCustomers()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("RemovePromotionCustomers", queryString);
        ...
        private void PromotionSaveRelative()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("PromotionSaveRelative", queryString);
        }
        ...
        private void PromotionApproved()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("PromotionApproved", queryArray);
        }
        ...
        private void PromotionEditable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("PromotionEditable", queryArray);
        }
        ...
        private void PromotionDeletable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("PromotionDeletable", queryArray);
        }
        ...
        private void PromotionVoidable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("PromotionVoidable", queryArray);
        }
        ...
        private void PromotionToggleApproved()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("PromotionToggleApproved", queryString);
        }
        ...
        private void PromotionToggleVoid()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("PromotionToggleVoid", queryString);
        }
        ...
        private void PromotionInitReference()
        {
            ...
            this.totalSmartPortalEntities.CreateTrigger("PromotionInitReference", simpleInitReference.CreateQuery());
        }
