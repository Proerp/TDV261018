...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class CommodityPrice
    {
        ...
        public CommodityPrice(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void GetCommodityPriceIndexes()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetCommodityPriceIndexes", queryString);
        }
        ...
        private void GetCommodityCodePart()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetCommodityCodePartA", queryString);
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetCommodityCodePartB", queryString);
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetCommodityCodePartC", queryString);
        }
...
//------UPDATE CommodityBrandID = 2: LVC
            ...
            queryString = queryString + "                       TotalSmartPortal_Brand_LVC.dbo.PromotionCommodityCodeParts PromotionCommodityCodeParts ON Commodities.CodePartA = PromotionCommodityCodeParts.CodePartA AND Commodities.CodePartC = PromotionCommodityCodeParts.CodePartC AND PromotionCommodityCodeParts.PromotionID = 48 " + "\r\n";
...
//------UPDATE Weight
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("InportCommodities", queryString);
        }
