...
namespace TotalDAL.Helpers.SqlProgrammability.Generals
{
    public class AccessControl
    {
        ...
        public AccessControl(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void GetAccessLevel()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetAccessLevel", queryString);
        }
        ...
        private void GetApprovalPermitted()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetApprovalPermitted", queryString);
        }
        ...
        private void GetUnApprovalPermitted()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetUnApprovalPermitted", queryString);
        }
        ...
        private void GetVoidablePermitted()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetVoidablePermitted", queryString);
        }
        ...
        private void GetUnVoidablePermitted()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetUnVoidablePermitted", queryString);
        }
        ...
        private void GetShowDiscount()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetShowDiscount", queryString);
        }
        ...
        private void GetShowDiscountByCustomer()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetShowDiscountByCustomer", queryString);
        }
        ...
        private void UpdateLockedDate()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("UpdateLockedDate", queryString);
        }
    }
}
