...
namespace TotalDAL.Helpers.SqlProgrammability.Generals
{
    public class UserReference
    {
        ...
        public UserReference(TotalSmartPortalEntities totalSmartPortalEntities)
        {
        ...
        private void GetModuleDetailIndexes()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetTaskIndexes", queryString);
        }
        ...
        private void GetUserIndexes()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetUserIndexes", queryString);
        }
        ...
        private void GetLocationOrganizationalUnits()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetLocationOrganizationalUnits", queryString);
        }
        ...
        private void UserEditable()
        {
            ...
            this.totalSmartPortalEntities.CreateProcedureToCheckExisting("UserEditable", queryArray);
        }
        ...
        private void UserRegister()
        {
            ...
            queryString = queryString + "           FROM            (SELECT DISTINCT TaskID FROM ModuleDetails WHERE ModuleDetails.InActive = 0) AS ModuleDetails CROSS JOIN OrganizationalUnits" + "\r\n";
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("UserRegister", queryString);
        }
        ...
        private void UserUnregister()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("UserUnregister", queryString);
        }
        ...
        private void UserToggleVoid()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("UserToggleVoid", queryString);
        }
        ...
        private void GetUserAccessControls()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetUserAccessControls", queryString);
        }
        ...
        private void SaveUserAccessControls()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("SaveUserAccessControls", queryString);
        }
        ...
        private void GetUserReportControls()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("GetUserReportControls", queryString);
        }
