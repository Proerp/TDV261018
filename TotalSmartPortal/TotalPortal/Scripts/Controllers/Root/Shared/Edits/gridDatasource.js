define([], (function () {
    ...
    definedExemplar.prototype._updateTotalToFooterTemplate = function (fieldName, aggregateFunction) {//Refresh FooterTemplate for display
        ...
        //The following is old code, developed by LE MINH HIEP in early 2016. This works very well, EXCEPT: It can only refresh SINGLE AGGREGATE FORUMLA PER COLUMN (*******Upto now - April-2017 - it still works very well for TotalBikePortals + TotalSmartPortal*******)
