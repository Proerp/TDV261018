...
function handleOKEvent(tabIndex) {
    ...
    function _setParentInput(selectedDataItem) {
        ...
        window.parent.$("#PurchaseDate").val(selectedDataItem === undefined ? null : kendo.toString(selectedDataItem.EntryDate, window.parent.Settings.DateFormat));
        ...
        window.parent.$("#CustomerBirthday").val(selectedDataItem === undefined ? null : kendo.toString(selectedDataItem.CustomerBirthday, window.parent.Settings.DateFormat));
        ...
        window.parent.$("#BeginningDate").val(selectedDataItem === undefined ? null : kendo.toString(selectedDataItem.BeginningDate, window.parent.Settings.DateFormat));
        window.parent.$("#EndingDate").val(selectedDataItem === undefined ? null : kendo.toString(selectedDataItem.EndingDate, window.parent.Settings.DateFormat));
