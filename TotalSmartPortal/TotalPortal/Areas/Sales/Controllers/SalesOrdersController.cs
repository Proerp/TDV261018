...
namespace TotalPortal.Areas.Sales.Controllers
{
    public class SalesOrdersController : GenericViewDetailController<SalesOrder, SalesOrderDetail, SalesOrderViewDetail, SalesOrderDTO, SalesOrderPrimitiveDTO, SalesOrderDetailDTO, SalesOrderViewModel>
    {
        ...
        public override void AddRequireJsOptions()
        {
            ...
            warehouseTaskIDList.Append(","); warehouseTaskIDList.Append((int)GlobalEnums.WarehouseTaskID.DeliveryAdvice);
        ...
        protected override bool GetShowListedPrice(SalesOrderViewModel simpleViewModel)
        {
            return base.BaseService.GetShowListedPrice(simpleViewModel.PriceCategoryID);
        }

        protected override bool GetShowListedGrossPrice(SalesOrderViewModel simpleViewModel)
        {
